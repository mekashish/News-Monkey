...
export class News extends Component {
    ...
    async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=369a258f8094451e99168f59db242e7e&page=${this.state.page}&pageSize=${this.props.pageSize}`;
        ...
        return (
            <div className="container my-3" style={{ paddingTop: '70px' }}>
                ...
                <div className="container d-flex justify-content-end">
                    <button disabled={this.state.page <= 1} type="button" className="btn btn-dark my-3 mx-1" onClick={this.handlePrevClick}> &larr; Previous</button>
